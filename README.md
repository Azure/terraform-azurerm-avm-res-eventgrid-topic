...
Description: A map of event subscriptions to create on the Event Grid Topic.
...
Description: The managed identity configuration of the Event Grid Topic, including principal\_id and tenant\_id for system-assigned identity.
...
Description: The principal ID of the system-assigned managed identity for the Event Grid Topic.  
