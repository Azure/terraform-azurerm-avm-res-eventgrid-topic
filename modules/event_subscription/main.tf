...
locals {
  ...
  delivery_identity_azure_function_props = var.delivery_with_resource_identity != null && try(var.delivery_with_resource_identity.destination.azure_function, null) != null ? {
  ...
  delivery_identity_endpoint_type = (
    ...
    try(var.delivery_with_resource_identity.destination.azure_function, null) != null ? "AzureFunction" :
    try(var.delivery_with_resource_identity.destination.event_hub, null) != null ? "EventHub" :
    try(var.delivery_with_resource_identity.destination.hybrid_connection, null) != null ? "HybridConnection" :
    try(var.delivery_with_resource_identity.destination.monitor_alert, null) != null ? "MonitorAlert" :
    try(var.delivery_with_resource_identity.destination.namespace_topic, null) != null ? "NamespaceTopic" :
    try(var.delivery_with_resource_identity.destination.service_bus_queue, null) != null ? "ServiceBusQueue" :
    try(var.delivery_with_resource_identity.destination.service_bus_topic, null) != null ? "ServiceBusTopic" :
    try(var.delivery_with_resource_identity.destination.storage_queue, null) != null ? "StorageQueue" :
    try(var.delivery_with_resource_identity.destination.webhook, null) != null ? "WebHook" : null
  )
  delivery_identity_event_hub_props = var.delivery_with_resource_identity != null && try(var.delivery_with_resource_identity.destination.event_hub, null) != null ? {
    resourceId                = var.delivery_with_resource_identity.destination.event_hub.resource_id
    deliveryAttributeMappings = length(local.delivery_identity_attribute_mappings) > 0 ? local.delivery_identity_attribute_mappings : null
  } : null
  delivery_identity_hybrid_connection_props = var.delivery_with_resource_identity != null && try(var.delivery_with_resource_identity.destination.hybrid_connection, null) != null ? {
    resourceId                = var.delivery_with_resource_identity.destination.hybrid_connection.resource_id
    deliveryAttributeMappings = length(local.delivery_identity_attribute_mappings) > 0 ? local.delivery_identity_attribute_mappings : null
  } : null
  delivery_identity_monitor_alert_props = var.delivery_with_resource_identity != null && try(var.delivery_with_resource_identity.destination.monitor_alert, null) != null ? {
  ...
  delivery_identity_namespace_topic_props = var.delivery_with_resource_identity != null && try(var.delivery_with_resource_identity.destination.namespace_topic, null) != null ? {
  ...
  delivery_identity_service_bus_queue_props = var.delivery_with_resource_identity != null && try(var.delivery_with_resource_identity.destination.service_bus_queue, null) != null ? {
    resourceId                = var.delivery_with_resource_identity.destination.service_bus_queue.resource_id
    deliveryAttributeMappings = length(local.delivery_identity_attribute_mappings) > 0 ? local.delivery_identity_attribute_mappings : null
  } : null
  delivery_identity_service_bus_topic_props = var.delivery_with_resource_identity != null && try(var.delivery_with_resource_identity.destination.service_bus_topic, null) != null ? {
  ...
  delivery_identity_storage_queue_props = var.delivery_with_resource_identity != null && try(var.delivery_with_resource_identity.destination.storage_queue, null) != null ? {
  ...
  delivery_identity_webhook_props = var.delivery_with_resource_identity != null && try(var.delivery_with_resource_identity.destination.webhook, null) != null ? {
  ...
  dest_azure_function_props = var.destination != null && try(var.destination.azure_function, null) != null ? {
  ...
  dest_event_hub_props = var.destination != null && try(var.destination.event_hub, null) != null ? {
    resourceId                = var.destination.event_hub.resource_id
    deliveryAttributeMappings = length(local.delivery_attribute_mappings) > 0 ? local.delivery_attribute_mappings : null
  } : null
  dest_hybrid_connection_props = var.destination != null && try(var.destination.hybrid_connection, null) != null ? {
    resourceId                = var.destination.hybrid_connection.resource_id
    deliveryAttributeMappings = length(local.delivery_attribute_mappings) > 0 ? local.delivery_attribute_mappings : null
  } : null
  dest_monitor_alert_props = var.destination != null && try(var.destination.monitor_alert, null) != null ? {
  ...
  dest_namespace_topic_props = var.destination != null && try(var.destination.namespace_topic, null) != null ? {
    resourceId = var.destination.namespace_topic.resource_id
  } : null
  dest_service_bus_queue_props = var.destination != null && try(var.destination.service_bus_queue, null) != null ? {
    resourceId                = var.destination.service_bus_queue.resource_id
    deliveryAttributeMappings = length(local.delivery_attribute_mappings) > 0 ? local.delivery_attribute_mappings : null
  } : null
  dest_service_bus_topic_props = var.destination != null && try(var.destination.service_bus_topic, null) != null ? {
  ...
  dest_storage_queue_props = var.destination != null && try(var.destination.storage_queue, null) != null ? {
  ...
  dest_webhook_props = var.destination != null && try(var.destination.webhook, null) != null ? {
  ...
  destination_endpoint_type = (
    ...
    try(var.destination.azure_function, null) != null ? "AzureFunction" :
    try(var.destination.event_hub, null) != null ? "EventHub" :
    try(var.destination.hybrid_connection, null) != null ? "HybridConnection" :
    try(var.destination.monitor_alert, null) != null ? "MonitorAlert" :
    try(var.destination.namespace_topic, null) != null ? "NamespaceTopic" :
    try(var.destination.service_bus_queue, null) != null ? "ServiceBusQueue" :
    try(var.destination.service_bus_topic, null) != null ? "ServiceBusTopic" :
    try(var.destination.storage_queue, null) != null ? "StorageQueue" :
    try(var.destination.webhook, null) != null ? "WebHook" : null
  )
